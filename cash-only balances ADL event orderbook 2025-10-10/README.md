...
- `realtime_analysis_summary.json` – Summary statistics (median leverage ≈ 0.20x, 302 underwater accounts, −$23.19M total equity).
...
- Leverage metrics now reflect true cash backing at the ADL moment (median 0.20x; 99th percentile ~123x).
- Negative equity count is 302 accounts with an aggregate −$23.19M deficit.
- **Updated December 2025**: Fixed position size calculation bug - see `BUG_FIX_COMPARISON.md` for details.
