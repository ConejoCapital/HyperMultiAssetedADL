...
canonical_path = str(ROOT / 'data/canonical/cash-only balances ADL event orderbook 2025-10-10/adl_detailed_analysis_REALTIME.csv')
df = pd.read_csv(canonical_path)
df_raw = pd.read_csv(str(ROOT / 'data/canonical/cash-only balances ADL event orderbook 2025-10-10/adl_fills_full_12min_raw.csv'))
...
liquidations = pd.read_csv(str(ROOT / 'data/canonical/cash-only balances ADL event orderbook 2025-10-10/liquidations_full_12min.csv'))
