...
- Canonical Data: `cash-only balances ADL event orderbook 2025-10-10/adl_fills_full_12min_raw.csv`
- Extraction Script: `extract_full_12min_adl.py` (in HyperReplay repository)
